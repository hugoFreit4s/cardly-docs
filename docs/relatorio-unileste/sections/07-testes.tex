...
\begin{enumerate}
    ...
    \item \textbf{Disciplinas e cartões} --- CRUD completo em Minhas Disciplinas (botão \textbf{Gerenciar cartões}); disciplina pública aparece na comunidade; clone gera cópia independente.
